...
//fprintf(stderr, "it comes%d %d %d %d\n", curState->spent[p], curState->maxSpent, curState->spent[p], game->stack[p]);
...
int readState(const char *string, const Game *game, State *state)         // û\D3ù\FD
{
	int c, r;
