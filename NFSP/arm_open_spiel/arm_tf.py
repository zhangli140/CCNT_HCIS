  ...
  """
    ...
    """
        ...
        if not is_evaluation:
            ...
            if time_step.last():  # prepare for the next episode.
                if self.step_counter > self._replay_buffer_capacity:  # count of steps is larger than set length
                    self._last_loss_value = self.learn()
    ...
    """
        ...
        for i_iter in range(self.iteration):
            ...
            #     print("In Learn Test End: {}###################".format(i_iter))
    ...
    def __compute_losses(self, sampled_indices):
        ...
        tar_v, tar_q = self.__compute_targets(sampled_indices)
